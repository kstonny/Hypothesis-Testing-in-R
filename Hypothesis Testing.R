...
# t distribution
#P(t<=x)
pt(1.65,29) # observing t value upto 1.65 and defree of freedom is 29


# when we talk about univariate data or single distribution, the vfrebgree of fredom alwys 
# n-1 where n is the sa mple size

# We take a sample of 28 items the sample mean is 30, sample sd = 5, the sample comes
#from a population whose mean is 35, what are the chances we'll observe a sample mean 
#of atmost 30?
...
# hypothesis test of single sample mean 
## t tests ##
